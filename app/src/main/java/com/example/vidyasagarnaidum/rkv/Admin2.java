...
public class Admin2 extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //add the tab
        mTabLayout.addTab(mTabLayout.newTab().setText("Regular"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Remedial"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Lab"));
        mTabLayout.setTabGravity(TabLayout.GRAVITY_FILL);
        //Set up the viewpager with the sections bar
